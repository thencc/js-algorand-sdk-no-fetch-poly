...
type SpecificParameters = Pick<TransactionParams, 'stateProofType' | 'stateProof' | 'stateProofMessage'>;
interface Overwrites {
    type?: TransactionType.stpf;
}
type StateProofTransaction = ConstructTransaction<SpecificParameters, Overwrites>;

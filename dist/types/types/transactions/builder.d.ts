 ...
 */
type TransactionBaseWithSuggestedParams = Pick<TransactionParams, 'suggestedParams' | 'from' | 'type' | 'lease' | 'note' | 'reKeyTo'>;
/**
 * Transaction base with suggested params included as parameters
 */
type TransactionBaseWithoutSuggestedParams = Pick<TransactionParams, 'flatFee' | 'fee' | 'firstRound' | 'lastRound' | 'genesisHash' | 'from' | 'type' | 'genesisID' | 'lease' | 'note' | 'reKeyTo'>;
/**
 ...
 * of the parameters.
 */
export type TransactionBase = TransactionBaseWithoutSuggestedParams | TransactionBaseWithSuggestedParams | (TransactionBaseWithSuggestedParams & TransactionBaseWithoutSuggestedParams);
/**
 ...
 */
export type ConstructTransaction<A = {}, O extends Partial<TransactionBase & A> = {}> = DistributiveOverwrite<TransactionBase & A, O>;
/**
 * Only accept transaction objects that include suggestedParams as an object
 */
export type MustHaveSuggestedParams<T extends ConstructTransaction> = Extract<T, {
 ...
 */
export type MustHaveSuggestedParamsInline<T extends ConstructTransaction> = Extract<T, SuggestedParams>;
